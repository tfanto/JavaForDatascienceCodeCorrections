...
public class SimpleRegressionSample extends Application {
	...
	public void start(Stage stage) {
		...
		double[][] input = { { 1950, 8639369 }, { 1960, 9118700 }, { 1970, 9637800 }, { 1980, 9846800 },
				{ 1990, 9969310 }, { 2000, 10263618 } };
		...
		for (int i = 0; i < predictionYears.length; i++) {
			...
			addDataItem(projectedSeries, predictionYears[i], regression.predict(predictionYears[i]));
		}
	...
	public void addDataItem(XYChart.Series<Number, Number> series, Number x, Number y) {
